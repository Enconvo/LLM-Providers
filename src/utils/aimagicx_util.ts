...
export namespace AimagicxUtil {
     ...
     */
    export function convertMessagesToSingleMessage(messages: BaseChatMessageLike[]): { message: string, system?: string } {
        let systemMessage = '';
        ...
        for (const msg of messages) {
            if (msg.role === 'system') {
                ...
                systemMessage = typeof msg.content === 'string' ? msg.content : msg.content.map(content => {
